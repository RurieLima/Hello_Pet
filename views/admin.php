                    ...
                    <div class="columns p-1 mx-1 my-3 box has-background-danger">
                        <div class="column">
                            <div class="columns is-vcentered">
                                <div class="collumn ml-5">
                                    <span class="is-size-5 has-text-weight-bold has-text-white-bis">New pet:</span>
                                </div>
                                <div class="column is-one-quarter">
                                    <a class="button is-primary is-light my-3 tooltip" href="index.php?m=insert"><i class="material-icons">add_box</i>
                                        <span class="tooltiptext mb-3">Insert new pet</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="column">
                            <div>
                                ...
                                <p class="my-3 has-text-weight-bold has-text-white-bis">Total Users:&nbsp <span class="is-size-4 has-text-white-bis has-text-weight-bold"><?php echo $t; ?></span></p>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="is-vcentered">
                                                    <figure class="is-align-items-center">
                                                        <img src="<?php if(str_contains($value["user_img"], "https") == true){echo $value["user_img"];}else{echo "views/img/" .$value['user_img'];} ?>" class="figImgAdmin" alt="Placeholder image">
                                                    </figure>
                                                </td>
